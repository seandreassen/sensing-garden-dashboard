...
const rangePresets = ["24h", "7d", "30d", "3m", "custom"] as const;
...
const filtersSchema = z.object({
  ...
  startDate: z.string().optional().catch(filtersDefault.startDate),
  endDate: z.string().optional().catch(filtersDefault.endDate),
  hub: z.string().optional().catch(filtersDefault.hub),
